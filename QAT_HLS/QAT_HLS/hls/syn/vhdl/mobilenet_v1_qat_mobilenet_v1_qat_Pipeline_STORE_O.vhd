...
entity mobilenet_v1_qat_mobilenet_v1_qat_Pipeline_STORE_O is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mobilenet_v1_qat_mobilenet_v1_qat_Pipeline_STORE_O is 
...
attribute shreg_extract : string;
    ...
    signal logits_load_reg_150 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    add_ln29_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln29_fu_97_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_A) else "0";
    logits_address0 <= zext_ln29_fu_109_p1(4 - 1 downto 0);
    ...
    m_axi_gmem_0_WDATA <= logits_load_reg_150;
    ...
    zext_ln29_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
