...
module mobilenet_v1_qat_mobilenet_v1_qat_Pipeline_STORE_O (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln29_fu_103_p2 = (ap_sig_allocacmp_i_1 + 4'd1);
...
assign icmp_ln29_fu_97_p2 = ((ap_sig_allocacmp_i_1 == 4'd10) ? 1'b1 : 1'b0);

assign logits_address0 = zext_ln29_fu_109_p1;
...
assign m_axi_gmem_0_WDATA = logits_load_reg_150;
...
assign zext_ln29_fu_109_p1 = ap_sig_allocacmp_i_1;

endmodule //mobilenet_v1_qat_mobilenet_v1_qat_Pipeline_STORE_O
