...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mobilenet_v1_qat.autotvin_gmem.dat"
         "c.mobilenet_v1_qat.autotvin_input_r.dat"
         "c.mobilenet_v1_qat.autotvin_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mobilenet_v1_qat.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
