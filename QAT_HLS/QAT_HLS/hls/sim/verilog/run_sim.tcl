...
if {[file isfile mobilenet_v1_qat.autotvin.dat]} {
	file delete -force mobilenet_v1_qat.autotvin.dat
}

if {[file isfile mobilenet_v1_qat.autotvout.dat]} {
	file delete -force mobilenet_v1_qat.autotvout.dat
}
