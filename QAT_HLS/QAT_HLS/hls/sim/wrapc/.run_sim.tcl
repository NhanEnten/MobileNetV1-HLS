...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mobilenet_v1_qat.autotvin.dat"
	set constFileTvOut       "mobilenet_v1_qat.autotvout.dat"
	set constFileHdlTvIn     "mobilenet_v1_qat.autohdltvin.dat"
	set constFileHdlTvOut    "mobilenet_v1_qat.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
