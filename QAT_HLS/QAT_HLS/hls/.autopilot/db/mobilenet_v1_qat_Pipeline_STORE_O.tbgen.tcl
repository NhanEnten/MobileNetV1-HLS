set moduleName mobilenet_v1_qat_Pipeline_STORE_O
set isTopModule 0
...
set cdfgNum 17
set C_modelName {mobilenet_v1_qat_Pipeline_STORE_O}
...
set C_modelArgList {
	...
	{ logits float 32 regular {array 10 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ logits_address0 sc_out sc_lv 4 signal 2 } 
	{ logits_ce0 sc_out sc_logic 1 signal 2 } 
	{ logits_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	logits { ap_memory {  { logits_address0 mem_address 1 4 }  { logits_ce0 mem_ce 1 1 }  { logits_q0 mem_dout 0 32 } } }
}
