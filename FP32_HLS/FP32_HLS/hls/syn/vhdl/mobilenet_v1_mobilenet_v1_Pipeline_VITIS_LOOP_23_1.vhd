...
entity mobilenet_v1_mobilenet_v1_Pipeline_VITIS_LOOP_23_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mobilenet_v1_mobilenet_v1_Pipeline_VITIS_LOOP_23_1 is 
...
attribute shreg_extract : string;
    ...
    signal out_buf_load_reg_150 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                out_buf_load_reg_150 <= out_buf_q0;
            end if;
        end if;
    end process;
    ...
    add_ln23_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln23_fu_97_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_A) else "0";
    ...
    m_axi_gmem_0_WDATA <= out_buf_load_reg_150;
    ...
    out_buf_address0 <= zext_ln23_fu_109_p1(4 - 1 downto 0);
    out_buf_ce0 <= out_buf_ce0_local;

    out_buf_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    zext_ln23_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
