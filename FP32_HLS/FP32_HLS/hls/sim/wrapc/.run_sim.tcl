...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mobilenet_v1.autotvin.dat"
	set constFileTvOut       "mobilenet_v1.autotvout.dat"
	set constFileHdlTvIn     "mobilenet_v1.autohdltvin.dat"
	set constFileHdlTvOut    "mobilenet_v1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
