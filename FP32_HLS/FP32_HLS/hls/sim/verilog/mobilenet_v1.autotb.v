...
`define AUTOTB_DUT      mobilenet_v1
`define AUTOTB_DUT_INST AESL_inst_mobilenet_v1
`define AUTOTB_TOP      apatb_mobilenet_v1_top
`define AUTOTB_LAT_RESULT_FILE "mobilenet_v1.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mobilenet_v1.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mobilenet_v1_top
...
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.mobilenet_v1.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_r  "../tv/cdatafile/c.mobilenet_v1.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r  "../tv/cdatafile/c.mobilenet_v1.autotvin_output_r.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.mobilenet_v1.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.mobilenet_v1.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.mobilenet_v1.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.mobilenet_v1.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.mobilenet_v1.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 185650;
