...
//
//==============================================================
`ifndef MOBILENET_V1_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define MOBILENET_V1_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class mobilenet_v1_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "mobilenet_v1_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(mobilenet_v1_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(mobilenet_v1_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(mobilenet_v1_reference_model)::get(p_sequencer,"", "refm", refm))
