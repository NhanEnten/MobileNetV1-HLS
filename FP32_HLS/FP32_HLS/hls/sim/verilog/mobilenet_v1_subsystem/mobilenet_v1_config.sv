...
//
//==============================================================
`ifndef MOBILENET_V1_CONFIG__SV                        
    `define MOBILENET_V1_CONFIG__SV                    
                                                            
    class mobilenet_v1_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(mobilenet_v1_config)         
        ...
        function new (string name = "mobilenet_v1_config");
            super.new(name);                                
