...
//
//==============================================================
`ifndef MOBILENET_V1_SCOREBOARD__SV                                                       
    `define MOBILENET_V1_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class mobilenet_v1_scoreboard extends uvm_component;                                        
                                                                                               
        mobilenet_v1_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(mobilenet_v1_scoreboard)                                     
