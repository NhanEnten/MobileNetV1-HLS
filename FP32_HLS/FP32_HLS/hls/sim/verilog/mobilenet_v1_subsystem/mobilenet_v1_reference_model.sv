...
`ifndef MOBILENET_V1_REFERENCE_MODEL_SV
`define MOBILENET_V1_REFERENCE_MODEL_SV
typedef class mobilenet_v1_reference_model;
...
class mobilenet_v1_reference_model extends uvm_component;
`define TV_IN_gmem "../tv/cdatafile/c.mobilenet_v1.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.mobilenet_v1.autotvout_gmem.dat"
`define TV_IN_OFFSET_input_r "../tv/cdatafile/c.mobilenet_v1.autotvin_input_r.dat"
`define TV_IN_OFFSET_output_r "../tv/cdatafile/c.mobilenet_v1.autotvin_output_r.dat"
`define TV_IN_input_r "../tv/cdatafile/c.mobilenet_v1.autotvin_input_r.dat"
`define TV_OUT_input_r ""
`define TV_IN_output_r "../tv/cdatafile/c.mobilenet_v1.autotvin_output_r.dat"
`define TV_OUT_output_r ""
    ...
    `uvm_component_utils_begin(mobilenet_v1_reference_model)
