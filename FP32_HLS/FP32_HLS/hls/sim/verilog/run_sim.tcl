...
if {[file isfile mobilenet_v1.autotvin.dat]} {
	file delete -force mobilenet_v1.autotvin.dat
}

if {[file isfile mobilenet_v1.autotvout.dat]} {
	file delete -force mobilenet_v1.autotvout.dat
}
