...
module mobilenet_v1_mobilenet_v1_Pipeline_VITIS_LOOP_23_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln23_fu_103_p2 = (ap_sig_allocacmp_i_1 + 4'd1);
...
assign icmp_ln23_fu_97_p2 = ((ap_sig_allocacmp_i_1 == 4'd10) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = out_buf_load_reg_150;
...
assign out_buf_address0 = zext_ln23_fu_109_p1;

assign out_buf_ce0 = out_buf_ce0_local;

assign zext_ln23_fu_109_p1 = ap_sig_allocacmp_i_1;

endmodule //mobilenet_v1_mobilenet_v1_Pipeline_VITIS_LOOP_23_1
