set moduleName mobilenet_v1_Pipeline_GAP_C
set isTopModule 0
...
set cdfgNum 28
set C_modelName {mobilenet_v1_Pipeline_GAP_C}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict ifmap_gap { MEM_WIDTH 32 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict ifmap_gap_2 { MEM_WIDTH 32 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict ofmap_gap { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ ifmap_gap float 32 regular {array 512 { 1 1 } 1 1 }  }
	{ ifmap_gap_2 float 32 regular {array 512 { 1 1 } 1 1 }  }
	{ ofmap_gap float 32 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "ifmap_gap", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ifmap_gap_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ofmap_gap", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ ifmap_gap_address0 sc_out sc_lv 9 signal 0 } 
	{ ifmap_gap_ce0 sc_out sc_logic 1 signal 0 } 
	{ ifmap_gap_q0 sc_in sc_lv 32 signal 0 } 
	{ ifmap_gap_address1 sc_out sc_lv 9 signal 0 } 
	{ ifmap_gap_ce1 sc_out sc_logic 1 signal 0 } 
	{ ifmap_gap_q1 sc_in sc_lv 32 signal 0 } 
	{ ifmap_gap_2_address0 sc_out sc_lv 9 signal 1 } 
	{ ifmap_gap_2_ce0 sc_out sc_logic 1 signal 1 } 
	{ ifmap_gap_2_q0 sc_in sc_lv 32 signal 1 } 
	{ ifmap_gap_2_address1 sc_out sc_lv 9 signal 1 } 
	{ ifmap_gap_2_ce1 sc_out sc_logic 1 signal 1 } 
	{ ifmap_gap_2_q1 sc_in sc_lv 32 signal 1 } 
	{ ofmap_gap_address0 sc_out sc_lv 8 signal 2 } 
	{ ofmap_gap_ce0 sc_out sc_logic 1 signal 2 } 
	{ ofmap_gap_we0 sc_out sc_logic 1 signal 2 } 
	{ ofmap_gap_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ifmap_gap_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_gap", "role": "q0" }} , 
 	{ "name": "ifmap_gap_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "ifmap_gap", "role": "address1" }} , 
 	{ "name": "ifmap_gap_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ifmap_gap", "role": "ce1" }} , 
 	{ "name": "ifmap_gap_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_gap", "role": "q1" }} , 
 	...
 	{ "name": "ifmap_gap_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_gap_2", "role": "q0" }} , 
 	{ "name": "ifmap_gap_2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "ifmap_gap_2", "role": "address1" }} , 
 	{ "name": "ifmap_gap_2_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ifmap_gap_2", "role": "ce1" }} , 
 	{ "name": "ifmap_gap_2_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_gap_2", "role": "q1" }} , 
 	{ "name": "ofmap_gap_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "ofmap_gap", "role": "address0" }} , 
 	{ "name": "ofmap_gap_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ofmap_gap", "role": "ce0" }} , 
 	{ "name": "ofmap_gap_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ofmap_gap", "role": "we0" }} , 
 	{ "name": "ofmap_gap_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ofmap_gap", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	ifmap_gap { ap_memory {  { ifmap_gap_address0 mem_address 1 9 }  { ifmap_gap_ce0 mem_ce 1 1 }  { ifmap_gap_q0 mem_dout 0 32 }  { ifmap_gap_address1 MemPortADDR2 1 9 }  { ifmap_gap_ce1 MemPortCE2 1 1 }  { ifmap_gap_q1 MemPortDOUT2 0 32 } } }
	ifmap_gap_2 { ap_memory {  { ifmap_gap_2_address0 mem_address 1 9 }  { ifmap_gap_2_ce0 mem_ce 1 1 }  { ifmap_gap_2_q0 mem_dout 0 32 }  { ifmap_gap_2_address1 MemPortADDR2 1 9 }  { ifmap_gap_2_ce1 MemPortCE2 1 1 }  { ifmap_gap_2_q1 MemPortDOUT2 0 32 } } }
	ofmap_gap { ap_memory {  { ofmap_gap_address0 mem_address 1 8 }  { ofmap_gap_ce0 mem_ce 1 1 }  { ofmap_gap_we0 mem_we 1 1 }  { ofmap_gap_d0 mem_din 1 32 } } }
}
