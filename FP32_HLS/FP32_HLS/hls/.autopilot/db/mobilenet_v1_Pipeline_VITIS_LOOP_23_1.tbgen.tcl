set moduleName mobilenet_v1_Pipeline_VITIS_LOOP_23_1
set isTopModule 0
...
set cdfgNum 28
set C_modelName {mobilenet_v1_Pipeline_VITIS_LOOP_23_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict out_buf { MEM_WIDTH 32 MEM_SIZE 40 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln23 int 62 regular  }
	{ out_buf float 32 regular {array 10 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "CTRL_BUS"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "CTRL_BUS"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln23", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "out_buf", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_buf_address0 sc_out sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_buf_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "out_buf", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	out_buf { ap_memory {  { out_buf_address0 mem_address 1 4 }  { out_buf_ce0 mem_ce 1 1 }  { out_buf_q0 mem_dout 0 32 } } }
}
