...
#define CTRL_BUS_ADDR_INPUT_R_DATA  0x10
#define CTRL_BUS_BITS_INPUT_R_DATA  64
#define CTRL_BUS_ADDR_OUTPUT_R_DATA 0x1c
#define CTRL_BUS_BITS_OUTPUT_R_DATA 64
